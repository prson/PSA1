...
public class SynchronousMachine extends ConductingEquipment{
	...
	public ThermalGeneratingUnit memberOfGen;
	public RegulatingControl regControl;
	public EquipmentContainer memberOfEquipmentContainer;
	public BaseVoltage baseVoltage;
	
	
	public SynchronousMachine (String rdfId,String name, double ratedS, ThermalGeneratingUnit memberOfGen, RegulatingControl regControl, EquipmentContainer memberOfEquipmentContainer, BaseVoltage baseVoltage){
		super(rdfId,name);
		this.ratedS=ratedS;
